...
async function scrapeUnionHall() {
  ...
  const results = await Promise.all(pages.map(p =>
    fetchText(`https://www.eventbrite.com/api/v3/organizers/${UNIONHALL_ORG}/events/?page=${p}`, { label: 'Union Hall' })
...
module.exports = { scrapeGotham, scrapeStandupNY, scrapeTheStand, scrapeNYCC, scrapeUnionHall };
